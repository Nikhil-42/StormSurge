...
/*public partial class GameTime : Control
{
	...
	public override void _Ready()
	{
		...
		size = RectSize;
		globalPos = GetGlobalRect().Position;
	}
	...
	public override void _Process(double delta) {
		...
		UpdateLabel();
		RectSize = GameManager.Instance.ScaleUI(size);
		RectPosition = GameManager.Instance.ScaleUI(globalPos) - GetParent<Control>().GetGlobalPosition();
	}
